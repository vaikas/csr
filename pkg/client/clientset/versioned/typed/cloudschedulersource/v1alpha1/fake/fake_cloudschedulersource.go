...
var cloudschedulersourcesResource = schema.GroupVersionResource{Group: "sources.aikas.org", Version: "v1alpha1", Resource: "cloudschedulersources"}

var cloudschedulersourcesKind = schema.GroupVersionKind{Group: "sources.aikas.org", Version: "v1alpha1", Kind: "CloudSchedulerSource"}
...
func (c *FakeCloudSchedulerSources) List(opts v1.ListOptions) (result *v1alpha1.CloudSchedulerSourceList, err error) {
	...
	list := &v1alpha1.CloudSchedulerSourceList{}
...
func (c *FakeCloudSchedulerSources) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.CloudSchedulerSource, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(cloudschedulersourcesResource, c.ns, name, data, subresources...), &v1alpha1.CloudSchedulerSource{})
