...
import (
	...
	cloudschedulersource_v1alpha1 "github.com/vaikas-google/csr/pkg/apis/cloudschedulersource/v1alpha1"
	...
	v1alpha1 "github.com/vaikas-google/csr/pkg/client/listers/cloudschedulersource/v1alpha1"
...
type cloudSchedulerSourceInformer struct {
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SourcesV1alpha1().CloudSchedulerSources(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SourcesV1alpha1().CloudSchedulerSources(namespace).Watch(options)
			},
		},
		&cloudschedulersource_v1alpha1.CloudSchedulerSource{},
		resyncPeriod,
		indexers,
	)
}

func (f *cloudSchedulerSourceInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *cloudSchedulerSourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cloudschedulersource_v1alpha1.CloudSchedulerSource{}, f.defaultInformer)
}

func (f *cloudSchedulerSourceInformer) Lister() v1alpha1.CloudSchedulerSourceLister {
